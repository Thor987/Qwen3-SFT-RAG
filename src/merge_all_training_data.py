...
df1 = pd.read_parquet('./collect_data/Literature.parquet')
df12 = pd.read_json('./collect_data/data.jsonl', lines=True)
...
with open('./collect_data/merged_data.jsonl', 'w', encoding='utf-8') as f:
